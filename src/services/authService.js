...
async function registerUser(email,plainTextPassword, firstName, lastName) {
    ...
    if (typeof email !== 'string' || typeof plainTextPassword !== 'string' || typeof firstName !== 'string' || typeof lastName !== 'string') {
    ...
    return BaseResponse.success('User registered successfully', {user:userWithoutPassword, accessToken, refreshToken});
    }
    catch (error) {
